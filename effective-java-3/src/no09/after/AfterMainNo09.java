...
public class AfterMainNo09 {
	...
	public static void example01() {
		try(FileInputStream in = new FileInputStream("example01 input!")) {
	...
	public static void example02() {
		try(FileInputStream in = new FileInputStream("example02 input!");FileOutputStream out = new FileOutputStream("example02 output!") ) {
			in.read();
			out.write();
